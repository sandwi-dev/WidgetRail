...
Community addon 0.2.13 implemented; live WebView2 playback proof remains in
...
`WidgetBridge` composition, Spotify Community addon package 0.2.13, and a lazily
