...
The executable references the `GameBarAlternative.WidgetSdk` package supplied
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="GameBarAlternative.WidgetSdk"
                      Version="THE-VERSION-CREATED-BY-YOUR-GBAR-DISTRIBUTION" />
  </ItemGroup>
</Project>
```

Use the exact version and cleared local feed generated by the matching `gbar`
...
```powershell
gbar pack .\ExampleApplication -o .\ExampleApplication.gbarwidget
gbar install .\ExampleApplication.gbarwidget --accept-full-trust
gbar enable dev.example.application --accept-full-trust
```
