...
capabilities](../reference/capabilities.md); do not create raw broker messages or hard-code
operation IDs. The [Network Controls reference](../reference/network-controls.md) is the
...
The [Games & Apps reference](../reference/games-and-apps.md) shows paged installed-app reads,
authority-scoped durable SavedIds reconciled to short-lived launch IDs, and
Interactive-only exact launch. The retained
[Recent Apps reference](../archive/recent-apps.md) shows a read-only event stream with
...
[display and resolution behavior](../reference/display-and-resolution.md).
...
write-only private-secret services](../reference/community-companion-services.md); those
...
Continue with the [declarative UI reference](../reference/declarative-ui.md), [controller
input model](../reference/controller-input.md), [widget capabilities](../reference/capabilities.md), and
[WRSS reference](../reference/wrss.md). For packaging, GitHub Release publishing, hash
