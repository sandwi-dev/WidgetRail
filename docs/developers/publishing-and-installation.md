...
complete [packaging contract](../reference/widget-packaging.md).
...
- After acquisition and required digest comparison, the existing package
  ...
  catalog checks documented in the [packaging contract](../reference/widget-packaging.md).
...
worker is later launched. Review [security and trust](../maintainers/security-and-trust.md)
