...
3. **Live-check the accepted visible widgets sequence, then close package
   ...
   ownership gap. Finish active DLV-057: make the supported package command
   independent of deliberately preseeded warm build state, prove identical warm-
   main/repeated-main/detached-root hashes, and publish main-built `0.2.14`
   without deleting older immutable generations.
