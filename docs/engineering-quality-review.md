...
3. **Finish the current visible widgets sequence.** DLV-006 is accepted through
   ...
   DLV-018 candidate `039b7b8` remains unintegrated because slow artwork demand
   serializes UI bridge work and same-identity changed icons retain stale cache
   identity. Finish the already-started DLV-053 Spotify correction, then run
   DLV-054 before DLV-043 architecture cleanup.
