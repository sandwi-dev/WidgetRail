...
3. **Then close shared geometry and recovery.** Platform DLV-021 owns shared
   Button/ActionSurface/SectionHeader geometry; Widgets DLV-023 owns Spotify
   typed transient/fatal recovery after DLV-017.
