...
2. **Widgets DLV-039 — extract bridge client and residency ownership.**
   ...
   DLV-039 is assigned on that accepted closing commit and must remove direct
   registration/catalog/residency/idle/disposal mutation from the server while
   retaining its pipe-session, framing, Stop, dispatcher, and write authority.
