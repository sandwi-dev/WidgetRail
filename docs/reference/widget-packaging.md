...
[publishing and installation](../developers/publishing-and-installation.md). For the trust
boundary, see [security and trust](../maintainers/security-and-trust.md).
...
installation](../developers/publishing-and-installation.md#remote-acquisition-safety-boundary)
