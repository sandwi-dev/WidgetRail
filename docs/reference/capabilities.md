...
constraints, see
[Windows provider architecture](../maintainers/windows-provider-architecture.md). For the
broader trust decision, see [security and trust](../maintainers/security-and-trust.md).
