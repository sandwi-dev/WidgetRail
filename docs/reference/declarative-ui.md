...
[embedded-media lifecycle cookbook](../developers/embedded-media-widget.md). The starter
...
is the copyable packaged reference: three distinct PNGs embedded in the widget
assembly under stable manifest-resource names prove
...
guide](../developers/widget-authoring-guide.md#bounded-offset-paged-resources). Its
