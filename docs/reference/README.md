...
Use these pages for exact behavior after learning the basics. If you are new,
start with [Your first widget](../developers/widget-quickstart.md) and
[Core concepts](../developers/concepts.md).

## SDK and UI

- [SDK API map and advanced examples](sdk-reference.md)
...
- [Icon provenance](widget-icon-provenance.md)
- [Live window previews](window-previews.md)
- [Artwork cache](artwork-disk-cache.md)
