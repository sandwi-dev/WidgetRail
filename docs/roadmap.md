...
2. DLV-147/DLV-153 are accepted through `e5f9ece`: opt-in bounded GOG installed
   ...
   `6abfb60`. DLV-157 now adds exact per-game title overrides.
...
4. Keep accepted dashboard DLV-143, Spotify DLV-144, and Game Launcher
   DLV-148/151/154/156 live-verifying on PID 30680 and queue any user-observed correction ahead of
   later feature work.
