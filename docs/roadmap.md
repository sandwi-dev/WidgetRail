...
Accepted DLV-088/090 close durable hide/restore. Accepted DLV-114 `f285c9d`,
corrected by DLV-117 `6a96727` and integrated through `cff0d99`, adds a
controller-first exact-identity details route with honest two-selection variant
actions, committed feedback, and deterministic return focus. Additional store adapters remain
