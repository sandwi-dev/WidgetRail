...
Coherent cumulative candidate `922385d` includes `ed4fd8b` and `8d3dfff`, built Release with tests skipped, and is visibly running as PID 48264 with SHA-256 `BAEA356A3C493AACEA164A6B7CCB743E1897455DEEF0B43955DB5F988822A008`. Startup is clean; physical verdict, tests, and integration remain pending.
...
6. DLV-242 is accepted and integrated through `0cf92e2`; coherent integrated
   ...
   deferred.
7. DLV-243 corrected coherent candidate `922385d` is running as PID 48264 for physical slider review before tests or integration.
