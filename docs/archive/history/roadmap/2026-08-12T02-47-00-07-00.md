...
> roadmap exceeded 1,000 physical lines. It preserves prior planning evidence
> only. The current roadmap is [`../../roadmap.md`](../../../roadmap.md), and this
> snapshot is not implementation authority.
...
- Expand the implemented Spotify Community addon beyond its controller-first
  ...
  Mode gate applies. See [Spotify Web API integration](../../../reference/spotify-integration.md).
...
See [Windows provider architecture](../../../maintainers/windows-provider-architecture.md) for the
documented API facts, threading/lifetime rules, privacy boundary, and simulator
matrix, and the [Network Controls reference](../../../reference/network-controls.md) for the
