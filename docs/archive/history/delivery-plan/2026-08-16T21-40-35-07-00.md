...
This is immutable historical evidence captured on 2026-08-16 after DLV-262.
It is not implementation authority. Return to the active
...
[2026-08-16 03:27 snapshot](../../../history/delivery-plan/history/delivery-plan/2026-08-16T03-27-50-07-00.md).
...
`docs/archive/overlay-host-main-refactoring-review.md` from current main using an
...
references across 496 non-retired managed UI prototype files, including 5,502 references in 375
...
samples, and active public documentation. Closed retired managed UI prototype sources and immutable
...
pre-release product. Do not touch immutable history, closed retired managed UI prototype sources,
...
closed retired managed UI prototype evidence, third-party notices that accurately quote historical
