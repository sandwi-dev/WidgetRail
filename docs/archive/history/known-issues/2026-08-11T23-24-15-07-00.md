# Historical snapshot — known issues and active bug ledger

This is immutable historical evidence captured before compaction. It is not
implementation authority. Return to the active
[`docs/archive/known-issues.md`](../../known-issues.md) ledger for current dispositions.
