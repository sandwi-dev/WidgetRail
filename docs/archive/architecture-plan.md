...
decisions are documented in [platform architecture](../maintainers/platform-architecture.md)
...
resolution](../reference/display-and-resolution.md) for the exact contract and evidence.
