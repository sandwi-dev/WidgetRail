...
assignment tables or `docs/archive/delivery-plan.md` as the implementation queue.
...
work. `docs/archive/delivery-plan.md` is a stable workflow contract, not a queue.

The review and planning agent owns:

- `docs/archive/review-planner-goal.md`
- `docs/archive/implementation-agent-goal.md`
- `docs/archive/delivery-plan.md`
- `docs/archive/known-issues.md`
- `docs/archive/engineering-quality-review.md`
- `docs/archive/widget-authoring-experience-review.md`
- `docs/history/**`
...
- Post-checkpoint updates use only the generic versioned operations authorized
  by `docs/archive/widget-snapshot-cache-design.md`: typed document/node property
