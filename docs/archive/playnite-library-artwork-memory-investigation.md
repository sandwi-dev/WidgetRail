...
controller UX. See [widget residency](../reference/widget-residency.md).
...
application catalog disappear. See the [declarative UI reference](../reference/declarative-ui.md)
and [Playnite Library architecture](../reference/playnite-library.md).
...
scenario with [the performance contract](../maintainers/performance.md) and WIDGE-104 rather
...
- [Performance contract and evidence](../maintainers/performance.md)
- [Playnite Library architecture](../reference/playnite-library.md)
- [Declarative UI reference](../reference/declarative-ui.md)
- [Widget lifecycle and process residency](../reference/widget-residency.md)
