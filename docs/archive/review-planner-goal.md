...
This file, `docs/archive/implementation-agent-goal.md`, and `docs/archive/delivery-plan.md` own stable operating
...
1. Read this file, `docs/archive/delivery-plan.md`, and `docs/archive/implementation-agent-goal.md`.
...
evidence satisfying the current ship gates in `docs/archive/implementation-agent-goal.md`.
