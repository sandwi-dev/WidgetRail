...
The [widget quickstart](../developers/widget-quickstart.md), [declarative UI
reference](../reference/declarative-ui.md), and first-party Audio/Network tests demonstrate
these patterns.
