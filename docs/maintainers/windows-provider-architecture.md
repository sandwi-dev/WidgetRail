...
gates. See [widget capabilities](../reference/capabilities.md) for the author-facing API.
...
reference](../reference/games-and-apps.md).
...
[Network Controls reference](../reference/network-controls.md) for its authoring,
