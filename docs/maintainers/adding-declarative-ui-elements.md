...
author-facing [declarative UI reference](../reference/declarative-ui.md), the
[Widget SDK compatibility policy](../developers/widget-sdk-compatibility.md), the
[SDK evolution policy](../developers/widget-sdk-evolution.md), the
[WRSS reference](../reference/wrss.md), and the
...
[Widget SDK evolution](../developers/widget-sdk-evolution.md). Review the generated missing
...
- `docs/reference/declarative-ui.md` for the element contract and limits;
- `docs/reference/controller-ui-components.md` when it is a reusable controller pattern;
- `docs/developers/widget-authoring-guide.md` for API use and lifecycle/action caveats;
- `docs/reference/wrss.md` when a new selector or themeable state is exposed;
