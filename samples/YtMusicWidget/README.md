...
- **Play next** also works on playlists and albums. Songs are inserted together in their original order, including when shuffle is already enabled. The current song keeps playing.
