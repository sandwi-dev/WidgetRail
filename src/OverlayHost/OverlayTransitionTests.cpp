...
void ZoomPolicyHonorsInterruptionAndReducedMotion() {
    Near(widgetrail::OverlayEntranceZoomScale(0.0F, false), 0.88F, "opening starts twelve percent below full size");
    Near(widgetrail::OverlayEntranceZoomScale(0.5F, false), 0.94F, "interruption retains intermediate zoom");
