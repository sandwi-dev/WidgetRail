...
internal static class WidgetPresentationDiff
{
        ...
        ViewNode after)
    {
        ...
        Add(PresentationProperty.ControllerPrompt, before.ControllerPrompt, after.ControllerPrompt);
        ...
        Add(PresentationProperty.CollectionResetGeneration, before.CollectionResetGeneration, after.CollectionResetGeneration);
