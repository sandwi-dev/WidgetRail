...
foreach ($state in @('empty', 'playing', 'library', 'home', 'library-return', 'library-refresh', 'search')) {
...
& "$out/LayoutRendererProbe.exe" "$out/empty.json" "$out/playing.json" "$out/library.json" "$out/home.json" "$out/library-return.json" "$out/library-refresh.json" "$out/search.json"
