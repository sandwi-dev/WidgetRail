...
var tests = new (string Name, Func<Task> Run)[]
{
    ...
    ("GOG disabled client-missing empty and cancellation states are explicit",
        GogInstalledGameScenarios.DisabledClientMissingEmptyAndCancellationAreExplicit),
    ("GOG installed registrations are opaque distinct and launchable",
        GogInstalledGameScenarios.ValidRegistrationsAreOpaqueDistinctAndLaunchable),
    ...
    ("GOG refreshed registration and launch authority are exact",
        GogInstalledGameScenarios.RefreshAndLaunchAreGenerationExact),
